...
<template>
    <div class="card"  >
        <div class="poster">
            <img v-if="content.poster_path != null" :src="'https://image.tmdb.org/t/p/w342/' + content.poster_path" 
            :alt="content.title != undefined ? content.title + ' poster' : content.name + ' poster'">
        ...
        <div class="lang">
            ...
            <img v-if="content.langImg != null" :src="content.langImg" 
            :alt="content.title != undefined ? content.title + ' language icon' : content.name + ' language icon'">
